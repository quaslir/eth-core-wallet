...
namespace crypto_assets {
    inline std::vector<Asset> get_default_assets(uint64_t target_chain_id = 1) {
      ...
      switch (target_chain_id) {
        case 11155111: {
          assets.reserve(2);
          assets.push_back({"ETH", "Ethereum", "Sepolia", 11155111, "", 18, 0.0, 0.0, true, false, false, "ethereum"});
          assets.push_back({"USDC", "USD Coin", "Sepolia", 11155111, "0x1c7d4b196cb0c7b01d743fbc6116a902379c7238", 6, 0.0, 0.0, false, false, false, "usd-coin"});
          break;
        }
        case 1: {
          assets.reserve(2);
          assets.push_back({"ETH", "Ethereum", "Mainnet", 1, "", 18, 0.0, 0.0, true, false, false, "ethereum"});
          assets.push_back({"USDT", "Tether", "Mainnet", 1, "0xdac17f958d2ee523a2206206994597c13d831ec7", 6, 0.0, 0.0, false, false, false, "tether"});
          break;
        }
        case 137: {
          assets.reserve(1);
          assets.push_back({"MATIC", "Polygon", "Polygon", 137, "", 18, 0.0, 0.0, true, false, false, "matic-network"});
          break;
        }
        case 42161: {
                  assets.reserve(2);

                  assets.push_back({"ETH", "Ethereum", "Arbitrum", 42161, "", 18, 0.0, 0.0, true, false, false, "ethereum"});
                  assets.push_back({"USDC", "USD Coin", "Arbitrum", 42161, "0xaf88d065e77c8cc2239327c5edb3a432268e5831", 6, 0.0, 0.0, false, false, false, "usd-coin"});
                  break;
                }
        default:
          break;
